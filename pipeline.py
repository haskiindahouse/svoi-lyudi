...
def stage_build():
    ...
    # у Wikidata почти нет P576 (роспуск) у арт-групп — добиваем известными датами
    GROUP_DATES = {
        "Арзамас": (1815, 1818), "Зелёная лампа": (1927, 1939), "Могучая кучка": (1856, 1870),
        "Передвижники": (1870, 1923), "Абрамцевский художественный кружок": (1878, 1893),
        "Мир искусства": (1898, 1924), "Союз русских художников": (1903, 1923),
        "Бубновый валет": (1911, 1917), "Голубая роза": (1907, 1910), "Ослиный хвост": (1912, 1913),
        "Бродячая собака": (1911, 1915), "Цех поэтов": (1911, 1914), "Гилея": (1910, 1913),
        "ЛЕФ": (1922, 1929), "Серапионовы братья": (1921, 1926), "ОБЭРИУ": (1927, 1930),
        "Российская ассоциация пролетарских писателей": (1925, 1932),
        "Ассоциация художников революционной России": (1922, 1932),
        "Общество станковистов": (1925, 1931), "УНОВИС": (1919, 1922),
        "Митьки": (1984, None), "Московский концептуализм": (1970, None),
        "Ленинградский рок-клуб": (1981, 1991), "Озеро": (1996, None),
        "Семибанкирщина": (1996, 1998), "Московский Английский клуб": (1772, 1918),
    }
    for gname, g in seeds["groups"].items():
        if g["qid"] in nodes and gname in GROUP_DATES:
            f, t = GROUP_DATES[gname]
            nodes[g["qid"]]["birth"] = nodes[g["qid"]]["birth"] or f
            nodes[g["qid"]]["death"] = nodes[g["qid"]]["death"] or t
